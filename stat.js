...
//         activeColumn = 'O3',
//         activeTimeRange = [Date.UTC(2022, 1, 1), Date.UTC(2022, 12, 31)],
//         selectionTimeout = -1;
...
//             await setupCity(board, row.county, activeColumn, activeScale);
//         }
//     }
...
//         citiesTable.getRowIndexBy('county', county)
//     );
...
//         rangeTable.getCellAsNumber('SO2' + scale, 0) || 0,
//         true,
//         true
//     );
//     kpiO3.chart.series[0].points[0].update(
//         rangeTable.getCellAsNumber('O3' + scale, 0) || 0,
//         true,
//         true
//     );
